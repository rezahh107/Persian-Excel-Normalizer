...
تست‌ها رفتارهای اصلی normalization، حفظ فرمول‌ها، مسیر خروجی `.xlsx` / `.xlsm`، ساخت پوشه‌ی مقصد، cleanup در خطای ذخیره‌سازی و چند guard ایستا برای GUI را پوشش می‌دهند.
